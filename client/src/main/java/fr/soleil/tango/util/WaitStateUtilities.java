...
public class WaitStateUtilities {
     ...
     *
     * @param proxy     the proxy on which to monitor the state
     * @param waitState the state to wait
     ...
     * @param waitState   the state to wait
     * @param timeout     a timeout in ms
     * @param pollingTime the polling period in ms
     * @throws DevFailed
     * @throws TimeoutException
     */
    public static void waitWhileState(final DeviceProxy proxy, final DevState waitState, final long timeout,
     ...
     *
     * @param deviceProxy the proxy on which to monitor the state
     * @param expected    the final expected state. Throw DevFailed the final state f is not the expected one
     * @param waitState   the state to wait
     * @param timeout     a timeout in ms
     * @param polling     the polling period in ms
     * @throws DevFailed
     * @throws TimeoutException
     */
