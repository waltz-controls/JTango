...
public final class InsertExtractUtils {
     ...
     * @param <T>
     * @param da
     * @param type the output type (e.g. double[].class for SCALAR, double[].class for SPECTRUM, double[][].class for
     *             IMAGE)
     ...
     * @param <T>
     * @param da
     * @param type the output type (e.g. double.class for SCALAR, double[].class for SPECTRUM, double[].class for IMAGE)
     * @return single value for SCALAR, array of primitives for SPECTRUM and IMAGE
     * @throws DevFailed
     */
