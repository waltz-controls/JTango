...
package hzg.wpn.tango.client.util;
...
public class TangoUtilsTest {
    ...
    public void testCreateDevError_StringReason() throws Exception {
        ...
        assertTrue(result.origin.startsWith("[hzg.wpn.tango.client.util.TangoUtilsTest.testCreateDevError_StringReason"));
    }
    ...
    public void testCreateDevError_ThrowableReason() throws Exception {
        ...
        assertEquals("failed due testing", result.desc);
        assertSame(ErrSeverity.ERR, result.severity);
        assertTrue(result.origin.startsWith("[hzg.wpn.tango.client.util.TangoUtilsTest.testCreateDevError_ThrowableReason"));
    }
}
