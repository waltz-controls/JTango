...
public class Util {
     ...
     * process.
     *
     * @throws DevFailed If the device pattern initialistaion failed Click <a
     *                   href="../../tango_basic/idl_html/Tango.html#DevFailed"
     *                   >here</a> to read <b>DevFailed</b> exception specification
     */
     ...
     * @throws DevFailed If in the device server process there is no TANGO device
     ...
     * @throws DevFailed If in the device is not served by one device pattern
